...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
        ...
        <div class="flex flex-1 flex-col gap-8 max-xl:flex-auto">
            ...
            <div class="flex flex-col gap-2">
                ...
                <?php echo $__env->make('admin::dashboard.over-all-details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            ...
            <div class="flex flex-col gap-2">
                ...
                <?php echo $__env->make('admin::dashboard.todays-details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            ...
            <div class="flex flex-col gap-2">
                ...
                <!-- Products List -->  
                <?php echo $__env->make('admin::dashboard.stock-threshold-products', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        ...
        <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
            ...
            <div class="box-shadow rounded bg-white dark:bg-gray-900">
                <!-- Total Sales Details -->
                <?php echo $__env->make('admin::dashboard.total-sales', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <!-- Total Visitors Details -->
                <?php echo $__env->make('admin::dashboard.total-visitors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <!-- Top Selling Products -->
                <?php echo $__env->make('admin::dashboard.top-selling-products', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <!-- Top Customers -->
                <?php echo $__env->make('admin::dashboard.top-customers', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
    ...
    <?php if (! $__env->hasRenderedOnce('02aca742-26bf-43d4-9c30-c153219007e4')): $__env->markAsRenderedOnce('02aca742-26bf-43d4-9c30-c153219007e4');
...
<?php endif; ?>
<?php /**PATH /home/makbulmart/public_html/packages/Webkul/Admin/src/Providers/../Resources/views/dashboard/index.blade.php ENDPATH**/ ?>
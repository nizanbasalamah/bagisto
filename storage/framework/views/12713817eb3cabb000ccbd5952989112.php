...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.shimmer.dashboard.total-sales','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php if (! $__env->hasRenderedOnce('b52d7b04-d6e1-4161-89ce-ced5aeff056e')): $__env->markAsRenderedOnce('b52d7b04-d6e1-4161-89ce-ced5aeff056e');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.charts.bar','data' => [':labels' => 'chartLabels',':datasets' => 'chartDatasets',':aspectRatio' => '1.41']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /home/makbulmart/public_html/packages/Webkul/Admin/src/Providers/../Resources/views/dashboard/total-visitors.blade.php ENDPATH**/ ?>
...
<?php if (! $__env->hasRenderedOnce('4a454abc-d23d-4ad3-95aa-dfa3971544fa')): $__env->markAsRenderedOnce('4a454abc-d23d-4ad3-95aa-dfa3971544fa');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.products.card','data' => ['class' => 'min-w-[291px] max-md:h-fit max-md:min-w-56 max-sm:min-w-[192px]','vFor' => 'product in products']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/makbulmart/public_html/packages/Webkul/Shop/src/Providers/../Resources/views/components/products/carousel.blade.php ENDPATH**/ ?>
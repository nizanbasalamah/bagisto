...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.tinymce.index','data' => ['selector' => 'textarea#' . $attributes->get('id'),'prompt' => stripcslashes($attributes->get('prompt', '')),':field' => 'field']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.index','data' => [':class' => '[errors && errors[\''.e($name).'\'] ? \'border !border-red-500\' : \'\']','attributes' => $attributes,'name' => ''.e($name).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endswitch; ?>
<?php /**PATH /home/makbulmart/public_html/packages/Webkul/Shop/src/Providers/../Resources/views/components/form/control-group/control.blade.php ENDPATH**/ ?>
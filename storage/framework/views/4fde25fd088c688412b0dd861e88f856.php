...
<?php if (! $__env->hasRenderedOnce('cb7b3fb4-1770-4555-8e43-4918ff703347')): $__env->markAsRenderedOnce('cb7b3fb4-1770-4555-8e43-4918ff703347');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.modal.index','data' => ['ref' => 'magicAIModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['type' => 'select','name' => 'model','rules' => 'required','v-model' => 'ai.model','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('admin::app.components.tinymce.ai-generation.model'))]); ?>
                                <option value="gpt-3.5-turbo">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.gpt-3-5-turbo'); ?>
                                </option>

                                <option value="llama2">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama2'); ?>
                                </option>

                                <option value="mistral">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.mistral'); ?>
                                </option>

                                <option value="dolphin-phi">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.dolphin-phi'); ?>
                                </option>

                                <option value="phi">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.phi'); ?>
                                </option>

                                <option value="starling-lm">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.starling-lm'); ?>
                                </option>

                                <option value="llama2-uncensored">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama2-uncensored'); ?>
                                </option>

                                <option value="llama2:13b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama2:13b'); ?>
                                </option>

                                <option value="llama2:70b">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llama2:70b'); ?>
                                </option>
                                ...
                                <option value="vicuna">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.vicuna'); ?>
                                </option>

                                <option value="llava">
                                    <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.llava'); ?>
                                </option>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal7b1bc76a00ab5e7f1bf2c6429dae85a3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7b1bc76a00ab5e7f1bf2c6429dae85a3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.index','data' => ['class' => 'mt-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin::form.control-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php $component->withAttributes(['class' => 'mt-5']); ?>
                            <?php if (isset($component)) { $__componentOriginal8378211f70f8c39b16d47cecdac9c7c8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8378211f70f8c39b16d47cecdac9c7c8 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.label','data' => ['class' => 'text-left']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin::form.control-group.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginal53af403f6b2179a3039d488b8ab2a267 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53af403f6b2179a3039d488b8ab2a267 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.form.control-group.control','data' => ['type' => 'textarea','class' => 'h-[180px]','name' => 'content','vModel' => 'ai.content']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin::form.control-group.control'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
                     ...
                     <?php $__env->slot('footer', null, []); ?> 
                        <div class="flex items-center gap-x-2.5">
                            <button
                                ...
                                @click="apply"
                            >
                                <?php echo app('translator')->get('admin::app.components.tinymce.ai-generation.apply'); ?>
                            </button>
                        </div>
                     <?php $__env->endSlot(); ?>
                 <?php echo $__env->renderComponent(); ?>
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /home/makbulmart/public_html/packages/Webkul/Admin/src/Providers/../Resources/views/components/tinymce/index.blade.php ENDPATH**/ ?>